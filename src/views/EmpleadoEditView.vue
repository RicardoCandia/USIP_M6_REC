    ...
    <div>
        ...
        <div class="row card p-2" style="max-width: 650px;">
            ...
            <form class="col s12" @submit.prevent="saveProduct()">
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input id="phone" type="number" class="validate" v-model="payload.color">
                        <label for="phone"> Color</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
                        <input id="phone" type="number" class="validate" v-model="payload.placa">
                        <label for="phone"> Placa</label>
                    </div>
                </div>
                <div class="row">
                    <div class="input-field col s12">
