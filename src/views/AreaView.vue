    ...
    <div>
        ...
        <tabs>
            <template v-slot:lista>
                <search placeholder="Buscar Area" @searchtext="searchFx($event)"></search>
...
export default {
    ...
    methods: {
        ...
        getItems() {
            this.axios({
                method: 'get',
                url: this.api + '/areas?_expand=name' + this.toSearch 
            })
                .then((response) => {
